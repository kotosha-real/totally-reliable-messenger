  ...
  <div class="settings-window">
    <div class="settings-window__container">
      ...
      <div class="settings-user__block settings-user__block_small">
        <div class="settings-user__field">
          <div class="settings-user__key">
            {{> button (createObject value = 'Edit data' id = 'buttonEditData' classList = (createArray 'btn_common')) }}
          </div>
        </div>
        <div class="settings-user__field">
          <div class="settings-user__key">
      ...
      <div class="settings-user__block">
        <div class="settings-user__field">
          <div class="settings-user__key">
            {{> button (createObject value = 'Delete account' id = 'buttonDeleteAccount' classList = (createArray 'btn_flat' 'btn_flat_danger')) }}
          </div>
        </div>
      </div>
    </div>
